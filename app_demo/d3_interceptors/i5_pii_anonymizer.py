...
from aidial_interceptors_sdk.examples.chat_completion import SpacyAnonymizerInterceptor
...
pirate_interceptor_app = interceptor_to_chat_completion(
    cls=SpacyAnonymizerInterceptor,
    dial_url=DIAL_URL,
...
app.add_chat_completion(deployment_name="pii-anonymizer", impl=pirate_interceptor_app)

if __name__ == "__main__":
    uvicorn.run(app, port=5045, host="0.0.0.0", log_level="info")
